...
-- Returns model-only user messages (hidden goal messages and compaction
-- summaries) regardless of compaction boundaries. Used by chatd so goal
-- turn boundaries stay visible to generation decisions when a compaction
