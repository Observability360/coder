...
// ChatGoalExistsByRootChatID mocks base method.
func (m *MockStore) ChatGoalExistsByRootChatID(ctx context.Context, rootChatID uuid.UUID) (bool, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ChatGoalExistsByRootChatID", ctx, rootChatID)
	ret0, _ := ret[0].(bool)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// ChatGoalExistsByRootChatID indicates an expected call of ChatGoalExistsByRootChatID.
func (mr *MockStoreMockRecorder) ChatGoalExistsByRootChatID(ctx, rootChatID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ChatGoalExistsByRootChatID", reflect.TypeOf((*MockStore)(nil).ChatGoalExistsByRootChatID), ctx, rootChatID)
}
